...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserList&&const DeepCollectionEquality().equals(other.values, values));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<UserEntityModel> values)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserList() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<UserEntityModel> values)  $default,) {final _that = this;
switch (_that) {
case _UserList():
return $default(_that.values);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<UserEntityModel> values)?  $default,) {final _that = this;
switch (_that) {
case _UserList() when $default != null:
return $default(_that.values);case _:
  return null;
...
class _UserList extends UserList {
  const _UserList({required final  List<UserEntityModel> values}): _values = values,super._();
  

 final  List<UserEntityModel> _values;
@override List<UserEntityModel> get values {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserList&&const DeepCollectionEquality().equals(other._values, _values));
}
