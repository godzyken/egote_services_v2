...
mixin _$UserPreferences {
 ...
 UserEntityModel get userEntityModel; ThemeMode get themeMode; String get about; bool get isDarkMode;
...
@override
int get hashCode => Object.hash(runtimeType,userEntityModel,themeMode,about,isDarkMode);
...
@useResult
$Res call({
 UserEntityModel userEntityModel, ThemeMode themeMode, String about, bool isDarkMode
});
...
/// Create a copy of UserPreferences
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userEntityModel = null,Object? themeMode = null,Object? about = null,Object? isDarkMode = null,}) {
  return _then(_self.copyWith(
userEntityModel: null == userEntityModel ? _self.userEntityModel : userEntityModel // ignore: cast_nullable_to_non_nullable
as UserEntityModel,themeMode: null == themeMode ? _self.themeMode : themeMode // ignore: cast_nullable_to_non_nullable
as ThemeMode,about: null == about ? _self.about : about // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UserEntityModel userEntityModel,  ThemeMode themeMode,  String about,  bool isDarkMode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserPreferences() when $default != null:
return $default(_that.userEntityModel,_that.themeMode,_that.about,_that.isDarkMode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UserEntityModel userEntityModel,  ThemeMode themeMode,  String about,  bool isDarkMode)  $default,) {final _that = this;
switch (_that) {
case _UserPreferences():
return $default(_that.userEntityModel,_that.themeMode,_that.about,_that.isDarkMode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UserEntityModel userEntityModel,  ThemeMode themeMode,  String about,  bool isDarkMode)?  $default,) {final _that = this;
switch (_that) {
case _UserPreferences() when $default != null:
return $default(_that.userEntityModel,_that.themeMode,_that.about,_that.isDarkMode);case _:
  return null;
...
class _UserPreferences extends UserPreferences {
  const _UserPreferences({required this.userEntityModel, required this.themeMode, required this.about, required this.isDarkMode}): super._();
...
/// Create a copy of UserPreferences
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userEntityModel = null,Object? themeMode = null,Object? about = null,Object? isDarkMode = null,}) {
